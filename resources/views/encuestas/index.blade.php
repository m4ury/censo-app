...
@section('content')
    ...
    <div class="row">
        <div class="col col-sm-2">
            {{ html()->form('GET', route('encuestas.index'))->id('myForm')->open() }}
{{ html()->select('q', ['2022' => '2022', '2023' => '2023', '2024' => '2024', '2025' => '2025'], null)->class('col col-sm')->id('q')->placeholder('Por año')->attribute('onchange', 'submitForm()') }}
        </div>
                ...
                <tbody>
                    @foreach ($encuestas as $encuesta)
                        <tr>
                            ...
                            <td>
                                {{ html()->form('DELETE', route('encuestas.destroy', $encuesta->id))->class('confirm')->open() }}
