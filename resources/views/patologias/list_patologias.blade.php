                ...
                <div class="list-group-item list-group-item my-3 text-bold ">
                    ...
                    @if ($patologia->nombre_patologia === 'SALA ERA')
                        <div class="form-group row">
                            ...
                            @endif
                            @if (Carbon\Carbon::parse($paciente->controls()->pluck('espirometriaVigente')->whereNotNull()->last())->diffInDays(Carbon\Carbon::now()) <= 365 &&
                                    $paciente->controls()->pluck('espirometriaVigente')->whereNotNull()->last() != '0000/00/00')
                                <div class="col-sm">
                                    <strong><i class="fas fa-thumbs-up text-success"></i> Espirometria Vigente
                                    </strong>
                                    <p class="btn rounded-pill bg-gradient-success">
                                        fecha: {{ $paciente->controls()->pluck('espirometriaVigente')->whereNotNull()->last() }}</P>
                                </div>
                            @elseif(Carbon\Carbon::parse($paciente->controls()->pluck('espirometriaVigente')->whereNotNull()->last())->diffInDays(Carbon\Carbon::now()) > 365)
                                <div class="col-sm-3">
                                    <strong><i class="fas fa-thumbs-down text-danger mr-1"></i>Espirometria Vigente:
                                        NO</strong>
                                    <p class="btn rounded-pill bg-gradient-danger">
                                        fecha: {{ $paciente->controls()->pluck('espirometriaVigente')->whereNotNull()->last() }}</p>
                                </div>
                            @else
                                <div class="col-sm-3">
                                    <strong><i class="fas fa-question-circle mr-1"></i>Espirometria Vigente</strong>
                                    <p class="btn badge-pill bg-gradient-secondary ml-3">No hay datos...</p>
                        ...
                        <div class="form-group row">
                            @if ($paciente->controls()->pluck('trHumor')->whereNotNull()->last())
                                <div class="col-sm">
                                    ...
                                    <p class="btn rounded-pill bg-gradient-success">
                                        {{ $paciente->controls()->pluck('trHumor')->whereNotNull()->last() }} </P>
                                </div>
                            @elseif($paciente->controls()->pluck('trConsumo')->whereNotNull()->last())
                                <div class="col-sm">
                                    ...
                                    <p class="btn rounded-pill bg-gradient-warning">
                                        {{ $paciente->controls()->pluck('trConsumo')->whereNotNull()->last() }} </P>
                                </div>
                            @elseif($paciente->controls()->pluck('trInfAdol')->whereNotNull()->last())
                                <div class="col-sm">
                                    ...
                                    <p class="btn rounded-pill bg-gradient-warning">
                                        {{ $paciente->controls()->pluck('trInfAdol')->whereNotNull()->last() }} </P>
                                </div>
                                ...
                                <div class="col-sm">
                                    ...
                                    <p class="btn rounded-pill bg-gradient-warning">
                                        {{ $paciente->controls()->pluck('trAns')->whereNotNull()->last() }} </P>
                                </div>
                                ...
                                <div class="col-sm">
                                    ...
                                    <p class="btn rounded-pill bg-gradient-warning">
                                        {{ $paciente->controls()->pluck('trDesarrollo')->whereNotNull()->last() }} </P>
                                </div>
                                ...
                                <div class="col-sm">
                                    ...
                                    <p class="btn rounded-pill bg-gradient-warning">
                                        {{ $paciente->controls()->pluck('diagSm')->whereNotNull()->last() }} </P>
                                </div>
                            @else
                                <div class="col-sm">
