...
@section('content')
    <div class="col-md-12 table-responsive">
        <div class="col text-center py-3">
            <h3 class="text-bold">Pacientes Multimorbilidad riesgo <span class="text-orange">Moderado</span> </h3>
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"
                                id="pacientes-total">{{ $g2->whereBetween('grupo', [15, 19])->count() }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"
                                id="pacientes-total">{{ $g2->whereBetween('grupo', [20, 44])->count() }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"
                                id="pacientes-total">{{ $g2->whereBetween('grupo', [45, 64])->count() }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"
                                id="pacientes-total">{{ $g2->where('grupo','>=',65)->count() }}</span>
                        </div>
                    </div>
                </div>
            </div>
