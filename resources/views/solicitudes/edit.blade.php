        ...
        <div class="row justify-content-left">
            <div class="col-sx-12 col-sm-12 col-lg-8">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            {!! Form::select('sol_estado', ['medicina' => 'entrgado a Medicina', 'some' => 'devuelto a SOME', 'solicitado' => 'Solicitado', 'a_social' => 'entregado a Asistente Social', 'psicologo' => 'entregado a Psicologa(a)', 'otros' => 'Otros', 'box medico' => 'en Box Medico'], old('sol_estado', $solicitud->sol_estado), ['class' => 'form-control form-control-sm', 'placeholder' => 'Seleccione Estado', 'id' => 'estado']) !!}
                        </div>
                    </div>
                <hr>
