            ...
            @foreach($solicitudes as $solicitud)
                <tr>
                    ...
                    @if($solicitud->sol_estado == 'solicitado')
                        <td><span class="mr-2">
                    <i class="fas fa-square text-primary"></i></span> Solicitado a SOME
                        </td>
                    @elseif($solicitud->sol_estado == 'medicina')
                        <td><span class="mr-2">
                    <i class="fas fa-square text-orange"></i></span> En Medicina
                        </td>
                    @elseif($solicitud->sol_estado == 'some')
                        <td><span class="mr-2">
                    <i class="fas fa-square text-white"></i></span> Devuelta a SOME
                        </td>
                    @endif
                    <td>
