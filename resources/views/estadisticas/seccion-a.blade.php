                ...
                <table id="pscv" class="table table-md-responsive table-bordered">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>{{$p_bajo->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_bajo->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$p_moderado->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->where('grupo', '>=', 80)->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->where('grupo', '>=', 80)->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->where('origin', true)->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->where('origin', true)->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_moderado->where('migrante', true)->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_moderado->where('migrante', true)->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td class="bg-gradient-gray"></td>
                        </tr>
                        <tr>
                            <th>ALTO</th>
                            ...
                            <td>{{$p_alto->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$p_alto->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$s_erc->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$s_erc->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$ercI->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercI->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$ercII->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercII->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$ercIIIa->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIa->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIa->where('grupo', '>=', 80)->where('sexo', '=', 'Masculino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$ercIIIb->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIIIb->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIIIb->where('grupo', '>=', 80)->where('sexo', '=', 'Masculino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$ercIV->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercIV->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$ercV->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercV->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                        ...
                        <tr>
                            ...
                            <td>{{$ercAll->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [15, 19])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [20, 24])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [25, 29])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [30, 34])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [35, 39])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [40, 44])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [45, 49])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [50, 54])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [55, 59])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [60, 64])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [65, 69])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [70, 74])->where('sexo', '=', 'Femenino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Masculino')->count() }}</td>
                            <td>{{$ercAll->whereBetween('grupo', [75, 79])->where('sexo', '=', 'Femenino')->count() }}</td>
                            ...
                            <td>{{ $dm2_sErc->count() + $dm2_ercI->count() + $dm2_ercII->count() + $dm2_ercIIIa->count() + $dm2_ercIIIb->count() + $dm2_ercIV->count() + $dm2_ercV->count() }}</td>
                            <td></td>
                        </tr>
                        </tr>
                    </thead>
