        ...
        <div class="card card-primary card-outline">
            <div class="card-body">
                <h4 class="card-title text-bold mb-3">
                    ...
                    SECCION A: POBLACIÓN EN CONTROL DE SALUD INTEGRAL DE ADOLESCENTES
                </h4>
                <div class="col-md-12">
                ...
                <div class="col-md-12 table-responsive">
                    <table id="sm" class="table table-md-responsive table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center" colspan="2" rowspan="3">Población en control</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th nowrap="" colspan="2">Total adolescentes en control</th>
                                <td class="bg-gradient-light">{{ $pAdolescente->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                                <td class="bg-gradient-light">
                                    {{ $pAdolescente->where('sexo', 'Masculino')->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                                <td class="bg-gradient-light">
                                    {{ $pAdolescente->where('sexo', 'Femenino')->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                                <td class="bg-gradient-light">{{ $pAdolescente->whereBetween('grupo', [10, 14])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('sexo', 'Masculino')->whereBetween('grupo', [10, 14])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('sexo', 'Femenino')->whereBetween('grupo', [10, 14])->count() }}
                                </td>
                                <td class="bg-gradient-light">{{ $pAdolescente->whereBetween('grupo', [15, 19])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('sexo', 'Masculino')->whereBetween('grupo', [15, 19])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('sexo', 'Femenino')->whereBetween('grupo', [15, 19])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('pueblo_originario', 1)->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('pueblo_originario', 1)->where('sexo', 'Masculino')->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('pueblo_originario', 1)->where('sexo', 'Femenino')->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('migrante', 1)->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('migrante', 1)->where('sexo', 'Masculino')->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                                <td>{{ $pAdolescente->where('migrante', 1)->where('sexo', 'Femenino')->whereBetween('grupo', [10, 19])->count() }}
                                </td>
                            </tr>
                        </thead>
                    </table>
                ...
                <div class="card-body">
                    <h4 class="card-title text-bold mb-3">
                        SECCION B: POBLACIÓN EN CONTROL DE SALUD INTEGRAL DE ADOLESCENTES, SEGÚN ESTADO NUTRICIONAL
                    </h4>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 table-responsive">
                        <table id="sm2" class="table table-md-responsive table-bordered">
                            <thead>
                                <tr>
                                    <th class="text-center" colspan="2" rowspan="3">Indicador Nutricional y
                                        Parámetros de medición</th>
                                </tr>
                                <tr>
                                    <th class="text-center" colspan="3">TOTAL</th>
                                    <th class="text-center" colspan="3">10 a 14 años</th>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $imc3DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc3DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $imc3DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}</td>
                                    <td>{{ $imc3DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc3DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $imc2DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc2DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $imc2DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}</td>
                                    <td>{{ $imc2DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc2DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $imc2DS->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}</td>
                                    <td>{{ $imc2DSM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $imc1DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc1DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $imc1DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}</td>
                                    <td>{{ $imc1DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc1DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $imc1DS->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}</td>
                                    <td>{{ $imc1DSM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $imc_1DS->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc_1DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc_1DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $imc_1DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc_1DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc_1DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $imc_1DS->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc_1DSM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $imc_2DS->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc_2DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc_2DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $imc_2DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc_2DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc_2DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $imc_2DS->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc_2DSM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $imc09DS->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc09DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc09DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $imc09DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc09DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $imc09DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $imc09DS->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $imc09DSM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $indTe_1DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $indTe_1DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $indTe_1DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}</td>
                                    <td>{{ $indTe_1DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $indTe_1DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $indTe_1DS->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}</td>
                                    <td>{{ $indTe_1DSM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $indTe_2DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $indTe_2DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $indTe_2DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}</td>
                                    <td>{{ $indTe_2DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $indTe_2DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $indTe_2DS->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}</td>
                                    <td>{{ $indTe_2DSM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $indTe_09DS->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $indTe_09DSM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $indTe_09DSF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $indTe_09DS->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $indTe_09DSM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $indTe_09DSF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $indTe_09DS->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $indTe_09DSM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $pcintNormal->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $pcintNormalM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $pcintNormalF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $pcintNormal->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $pcintNormalM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $pcintNormalF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $pcintNormal->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $pcintNormalM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $pcintRiesgo->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $pcintRiesgoM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $pcintRiesgoF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $pcintRiesgo->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $pcintRiesgoM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $pcintRiesgoF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $pcintRiesgo->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $pcintRiesgoM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $pcintObesidad->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    ...
                                    <td>{{ $pcintObesidad->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                <tr>
                                    <th rowspan="10" style="vertical-align: middle" nowrap>DIAGNOSTICO NUTRICIONAL
                                        INTEGRADO
                                    </th>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $sobrepesoM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $sobrepesoF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $sobrepeso->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}</td>
                                    <td>{{ $sobrepesoM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $sobrepesoF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $sobrepeso->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}</td>
                                    <td>{{ $sobrepesoM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    <th>OBESO SEVERO</th>
                                    <td>{{ $obesoSevero->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $obesoSeveroM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $obesoSeveroF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $obesoSevero->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $obesoSeveroM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $obesoSeveroF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $obesoSevero->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $obesoSeveroM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $desnutSecM->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>
                                    <td>{{ $desnutSecF->where('grupo', '>=', 10)->where('grupo', '<=', 19)->count() }}
                                    </td>

                                    <td>{{ $desnutSec->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}</td>
                                    <td>{{ $desnutSecM->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>
                                    <td>{{ $desnutSecF->where('grupo', '>=', 10)->where('grupo', '<=', 14)->count() }}
                                    </td>

                                    <td>{{ $desnutSec->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}</td>
                                    <td>{{ $desnutSecM->where('grupo', '>=', 15)->where('grupo', '<=', 19)->count() }}
                                    </td>
            ...
            @section('js')
                <script>
                    ...
                    function exportarTablaExcel2() {
                        var tabla = document.getElementById('sm2');
                        var wb = XLSX.utils.table_to_book(tabla, {
                            sheet: "Estadísticas"
                        });
                        XLSX.writeFile(wb, 'P9_seccionB.xlsx');
                    }
                </script>
            @endsection
