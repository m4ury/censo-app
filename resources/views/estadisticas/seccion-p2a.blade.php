            ...
            <div class="card-body">
                ...
                <div class="col-md-12 table-responsive">
                    <table id="sm" class="table table-md-responsive table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center" colspan="2" rowspan="3">"INDICADOR NUTRICIONAL Y PARÁMETROS DE MEDICIÓN"</th>
                            ...
                            <tr class="bg-gradient-light">
                                ...
                                <td>{{ $all->count() }}</td>
                                <td>{{ $all->count() }}</td>
                                <td>{{ $all->whereEdadEnMeses('<', 1)->whereSexo('Masculino')->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('<', 1)->whereSexo('Femenino')->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses( '==', 1)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses( '==', 1)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 2)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 2)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 3)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 3)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 4)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 4)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 5)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 5)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 6)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 6)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 7)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 7)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 8)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 8)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 9)->count() }}
                                </td>
                                <td>{{ $all->whereEdadEnMeses('==', 9)->count() }}
                                </td>
                                <td>{{ $all->wherePueblo_orig('==', 1)->count() }}
                                </td>
                                <td>{{ $all->whereEueblo_orig('==', 1)->count() }}
                                </td>
                                <td>{{ $all->whereMigrante('==', 1)->count() }}
                                </td>
                                <td>{{ $all->whereMigrante('==', 1)->count() }}
                                </td>
                                <td>{{ $all->whereMigrante('==', 1)->count() }}
                                ...
                                <td>{{ $all->where('mejor_ninez', 1)->count() }}
                                </td>
                                <td>{{ $all->where('mejor_ninez', 1)->count() }}
                                </td>
                            </tr>
