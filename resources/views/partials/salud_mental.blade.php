<div class="card card-success card-outline mb-3" id="Psicologo">
    ...
    <div class="form-group row my-2 ml-2 mx-3">
        ...
        <div class="col-sm">
            {!! Form::select(
                ...
                old('diagSm', $control->diagSm),
                ['class' => 'form-control form-control-sm diagSm', 'placeholder' => 'Seleccione una opción'],
            ) !!}
        </div>
    </div>
    ...
    <div class="form-group row my-2 ml-2 mx-3">
        ...
        <div class="col-sm">
            {!! Form::select(
                ...
                old('trHumor', $control->trHumor),
                ['class' => 'form-control form-control-sm trHumor', 'placeholder' => 'Seleccione una opción'],
            ) !!}
        </div>
    </div>
    <div class="form-group row my-2 ml-2 mx-3">
        ...
        <div class="col-sm">
            {!! Form::select(
                ...
                old('trConsumo', $control->trConsumo),
                ['class' => 'form-control form-control-sm trConsumo', 'placeholder' => 'Seleccione una opción'],
            ) !!}
        </div>
    </div>
        ...
        <div class="form-group row my-2 ml-2 mx-3">
            ...
            <div class="col-sm">
                {!! Form::select(
                    ...
                    old('trInfAdol', $control->trInfAdol),
                    ['class' => 'form-control form-control-sm trInfAdol', 'placeholder' => 'Seleccione una opción'],
                ) !!}
            </div>
        </div>
    @endif
    <div class="form-group row my-2 ml-2 mx-3">
        ...
        <div class="col-sm">
            {!! Form::select(
                ...
                old('trAns', $control->trAns),
                ['class' => 'form-control form-control-sm trAns', 'placeholder' => 'Seleccione una opción'],
            ) !!}
        </div>
    </div>

    <div class="form-group row my-2 ml-2 mx-3">
        {!! Form::label('trDesarrollo_label', 'TRASTORNOS GENERALIZADOS DEL DESARROLLO', [
            'class' => 'col-sm col-form-label',
        ]) !!}
        <div class="col-sm">
            {!! Form::select(
                ...
                old('trDesarrollo', $control->trDesarrollo),
                ['class' => 'form-control form-control-sm trDesarrollo', 'placeholder' => 'Seleccione una opción'],
            ) !!}
        </div>
    </div>
    ...
    <div class="form-group row my-2 ml-2 mx-3">
        ...
        <div class="col-sm">
            {!! Form::select(
                'demencias',
                ['leve' => 'Leve', 'moderado' => 'Moderado', 'avanzado' => 'Avanzado'],
                old('demencias', $control->demencias),
                ['class' => 'form-control form-control-sm demencias', 'placeholder' => 'Seleccione una opción'],
            ) !!}
        </div>
    </div>
</div>
