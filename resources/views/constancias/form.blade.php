...
<div class="form-group row">
    ...
    <div class="col-sm">
        {{ html()->select('problema_id', $problemas, old('problema_id', $const->problema_id))->class('form-control form-control-sm')->classIf($errors->has('problema_id'), 'is-invalid')->placeholder('Seleccione patologia')->id('problemas') }}
...
<div class="row">
    <div class="col-sm">
        ...
        {{ html()->checkbox('sospecha', old('sospecha', $const->sospecha ? true : null), 1)->class('form-control my-2 sospecha')->id('sospecha') }}
    </div>
    <div class="col-sm">
        <label for="diagnostico_label" class="col-sm col-form-label text-bold">Confirmación</label>
        {{ html()->checkbox('diagnostico', old('diagnostico', $const->diagnostico ? true : null), 1)->class('form-control my-2 diagnostico')->id('diagnostico') }}
    </div>
    <div class="col-sm">
        <label for="etapificacion_label" class="col-sm col-form-label text-bold">Etapificación</label>
        {{ html()->checkbox('etapificacion', old('etapificacion', $const->etapificacion ? true : null), 1)->class('form-control my-2 etapificacion')->id('etapificacion') }}
    </div>
    <div class="col-sm">
        <label for="tratamiento_label" class="col-sm col-form-label text-bold">Tratamiento</label>
        {{ html()->checkbox('tratamiento', old('tratamiento', $const->tratamiento ? true : null), 1)->class('form-control my-2 tratamiento')->id('tratamiento') }}
    </div>
    <div class="col-sm">
        <label for="seguimiento_label" class="col-sm col-form-label text-bold">Seguimiento</label>
        {{ html()->checkbox('seguimiento', old('seguimiento', $const->seguimiento ? true : null), 1)->class('form-control my-2 seguimiento')->id('seguimiento') }}
    </div>
    <div class="col-sm">
        <label for="rehab_label" class="col-sm col-form-label text-bold">Rehabilitación</label>
        {{ html()->checkbox('rehab', old('rehab', $const->rehab ? true : null), 1)->class('form-control my-2 rehab')->id('rehab') }}
    </div>
</div>
<hr>
<div class="form-group row">
    ...
    <div class="col-sm">
        ...
        {{ html()->checkbox('presencial', old('presencial', $const->presencial ? true : null), 1)->class('form-control my-2 presencial')->id('presencial') }}
    </div>
    <div class="col-sm">
        <label for="teleconsulta_label" class="col-sm col-form-label text-bold">Teleconsulta</label>
        {{ html()->checkbox('teleconsulta', old('teleconsulta', $const->teleconsulta ? true : null), 1)->class('form-control my-2 teleconsulta')->id('teleconsulta') }}
    </div>
</div>
<hr>
...
<div class="row py-2">
    ...
    {{ html()->input('datetime-local', 'fecha_notificacion', old('fecha_notificacion', $const->fecha_notificacion))->class('col-sm form-control form-control-sm') }}
</div>
<div class="row py-3" id="teleconsulta_fields">
    ...
    <div class="col-sm">
        {{ html()->select('medio_conocimiento', [
                ...
                'otros' => 'Otros (idicar)',
            ], old('medio_conocimiento', $const->medio_conocimiento))->class('form-control form-control-sm')->classIf($errors->has('medio_conocimiento'), 'is-invalid')->placeholder('Seleccione tipo')->id('medio_con') }}
...
<div class="collapse multi-collapse" id="multiCollapseExample2">
    <div class="row py-2">
        ...
        <div class="col-sm-6">
            {{ html()->text('otro_nombre', old('otro_nombre', $const->otro_nombre))->class('form-control form-control-sm')->classIf($errors->has('otro_nombre'), 'is-invalid')->placeholder('Nombres') }}
        ...
        <div class="col-sm">
            {{ html()->text('otro_run', old('otr_run', $const->otro_run))->class('form-control form-control-sm')->classIf($errors->has('otro_run'), 'is-invalid')->placeholder('RUN otra persona') }}
        ...
        <div class="col-sm-4">
            {{ html()->text('otro_telefono', old('otro_telefono', $const->otro_telefono))->class('form-control form-control-sm')->classIf($errors->has('otro_telefono'), 'is-invalid')->placeholder('Telefono') }}
        ...
        <div class="col-sm">
            {{ html()->text('otro_mail', old('otro_mail', $const->otro_mail))->class('form-control form-control-sm')->classIf($errors->has('otro_mail'), 'is-invalid')->placeholder('Mail otra persona') }}
