...
<?php $__env->startSection('auth_body'); ?>
    <form action="<?php echo e($register_url); ?>" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="rut" class="form-control <?php echo e($errors->has('rut') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('rut')); ?>" placeholder="Rut Ej.: 16 000 000-K" autofocus>
        ...
        <div class="input-group mb-3">
            <input type="text" name="name" class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('adminlte::adminlte.full_name')); ?>">
            <div class="input-group-append">
                <div class="input-group-text">
        ...
        <div class="input-group mb-3">
            <input type="text" name="apellido_pat" class="form-control <?php echo e($errors->has('apellido_pat') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('apellido_pat')); ?>" placeholder="Apellido paterno">
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user <?php echo e(config('adminlte.classes_auth_icon', '')); ?>"></span>
                </div>
        ...
        <div class="input-group mb-3">
            <input type="text" name="apellido_mat" class="form-control <?php echo e($errors->has('apellido_mat') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('apellido_mat')); ?>" placeholder="Apellido materno">
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user <?php echo e(config('adminlte.classes_auth_icon', '')); ?>"></span>
                </div>
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'register'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/censo-app/resources/views/auth/register.blade.php ENDPATH**/ ?>