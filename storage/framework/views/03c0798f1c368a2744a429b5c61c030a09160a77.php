<?php $__env->startSection('title', 'crear-pacientes'); ?>
            ...
            <div class="col-sx-12 col-sm-12 col-lg">
                <div class="card card-info card-outline">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <?php echo $__env->make('encuestas.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/censo-app/resources/views/encuestas/create.blade.php ENDPATH**/ ?>