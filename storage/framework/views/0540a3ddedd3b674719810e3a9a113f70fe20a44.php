...
<?php $__env->startSection('auth_body'); ?>
    <form action="<?php echo e($login_url); ?>" method="post">
        ...
        <div class="input-group mb-3">
            <input type="rut" name="rut" class="form-control <?php echo e($errors->has('rut') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('rut')); ?>" placeholder="<?php echo e(__('Rut Ej.: 16000000-K')); ?>" autofocus>
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/censo-app/resources/views/auth/login.blade.php ENDPATH**/ ?>